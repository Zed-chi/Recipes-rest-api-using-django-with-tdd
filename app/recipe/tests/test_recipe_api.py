...
class RecipeImageUploadTests(TestCase):
    ...
    def filter_recipe_by_tags(self):
        recipe1 = sample_recipe(user=self.user, title="qwe")
        recipe2 = sample_recipe(user=self.user, title="asd")
        tag1 = sample_tag(user=self.user, name="qwe")
        tag2 = sample_tag(user=self.user, name="asd")
    ...
    def filter_recipe_by_ingredients(self):
        recipe1 = sample_recipe(user=self.user, title="qwe")
        recipe2 = sample_recipe(user=self.user, title="asd")
        ingredient1 = sample_ingredient(user=self.user, name="qwe")
        ingredient2 = sample_ingredient(user=self.user, name="asd")
